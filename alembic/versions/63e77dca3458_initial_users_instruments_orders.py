...
def upgrade() -> None:
    ...
    sa.Column('ticker', sa.String(length=20), nullable=False),
    sa.Column('direction', sa.Enum('BUY', 'SELL', name='order_direction_enum'), nullable=False),
    ...
    with op.batch_alter_table('orders', schema=None) as batch_op:
        batch_op.create_index('ix_orders_active_for_matching', ['ticker', 'status', 'direction', 'price'], unique=False)
